...
import { BuildStorageSelect, BuildTabs, BuildStartSelect } from './classes/build'
//


document.addEventListener('DOMContentLoaded', () => {

    let storage = storageOut(KEY()[0])
    if (!!storage) {
        // построение из localStorage
        new BuildStorageSelect('select_1', ADMIN.googleList[0].list, 1)
        new BuildStorageSelect('options_1', ADMIN.googleList[2].list, ADMIN.tabs[0].value)
    ...
    function tabClick(event) {
        ...
        new BuildStorageSelect('options_1', ADMIN.googleList[2].list, $select_1.value)
